## This script generates PRS for multiple UKB diseases and traits
...
PHENOTYPE="${code}_UKB_control_p0.0001"
sum_stat="/summary_statistics/${code}_UKB_QC_biallelicSNPs.txt"
